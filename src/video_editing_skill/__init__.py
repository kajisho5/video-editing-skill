...
# never VERSION. Bumped to "3.0" for 0.3.0 (docs/decisions.md ADR-011): a new `ROTATE`
...
# a 0.2.x caller relied on. Previously bumped to "2.0" for 0.2.0 (ADR-009): FILL gained an
